...
const ProductEdit = () => {
  ...
  const handleUpdateMaterial = (index, updatedMaterial) => {
    ...
    const price = parseFloat(updatedMaterial.price)
    const totalPrice = calculateMaterialTotal(quantity, price)
    const taxAmount = calculateTax(totalPrice)
    const totalAmount = calculateMaterialTotalAmount(quantity, price)
        ...
        <div className="card">
          ...
          {formData.materials.length > 0 && (
            <div style={{ marginTop: '20px' }}>
              <h3 style={{ marginBottom: '15px' }}>Existing Materials:</h3>
              {formData.materials.map((material, index) => (
                <div key={index} className="material-item">
                  ...
                  <div className="material-row">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          const updated = { ...material, quantity: e.target.value }
                          handleUpdateMaterial(index, updated)
                        }}
                      />
                    </div>
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          const updated = { ...material, price: e.target.value }
                          handleUpdateMaterial(index, updated)
                        }}
                      />
                    </div>
                  ...
                  <div style={{ marginTop: '5px', fontSize: '14px', color: '#666' }}>
                    Total Price: ₹{material.totalPrice.toFixed(2)} | 
